...
public class Code {
    ...
    public static String dest(String mnemonic) throws InvalidOperationException {
        switch (mnemonic)
        {
            case "" : return "000" ;
            case "M" : return "001" ;
            ...
            case "AD" : return "110";
            case "AMD" : return "111";
            default: throw new InvalidOperationException("Unable to match dest with valid mnemonics") ;
        }
    }
    public static String comp(String mnemonic) throws InvalidOperationException {
        switch (mnemonic)
        {
            ...
            default: throw new InvalidOperationException("Unable to match comp with valid mnemonics");
        }
    }


    public static String jump(String mnemonic) throws InvalidOperationException {
        switch (mnemonic)
        {
            case "" : return "000" ;
            case "JGT" : return "001" ;
            ...
            case "JLE" : return "110";
            case "JMP" : return "111";
            default: throw new InvalidOperationException("Unable to match jump with valid mnemonics") ;
        }
    }
}
